import { createCareerPost, deleteCareerPost, getCareersMeta, listCareerPosts, updateCareerPost, upsertCareersMeta } from '@/firebase/careersService'
...
return useQuery({ queryKey: ['careersMeta'], queryFn: getCareersMeta })
}
