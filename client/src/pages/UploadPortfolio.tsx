...
import EngineeringDropdown from "@/components/portfolio/EngineeringDropdown";
...
const FileUpload = lazy(
  () => import("@/components/portfolio/FileUpload")
);
...
const UploadPortfolio = () => {
  ...
  const handleSubmit = async () => {
    ...
    const newErrors = validateSubmission(stepFile, pdfFile, explanation);
    setErrors(newErrors);
    ...
    try {
      ...
      // Log the data to see what is being saved
