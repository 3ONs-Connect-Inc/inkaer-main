      ...
      <main className="py-16">
        ...
        <section className="bg-gradient-to-br from-blue-50 to-indigo-100 py-16">
          <div className="mx-auto max-w-4xl padding">
            <Link to="/" className="inline-flex items-center text-small hover:text-gray-900 mb-8">
      ...
      <section className="py-16 bg-blue-600 text-white">
          <div className="mx-auto max-w-4xl padding text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link to="/" className="btn-responsive bg-white/10  text-white border-2 border-white/20 rounded-lg  hover:bg-white/20   inline-flex justify-center">
                  Learn More
              </Link>
            </div>
          </div>
